...
| 5 | `workflows/` | statement-import, posting, reclassification, opening-balances, import-presets, chart-of-accounts | The domain workflows, where the action happens: they sequence module calls and make the domain decisions | SQL, text formatting, HTTP; imports of each other |
...
and `workflows/chart-of-accounts.ts` (the setup wizard's first step: the
